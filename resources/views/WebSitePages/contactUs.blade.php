            ...
            <div class="contect-dir">
                <div class="dir-blocks">
                    <div class="address_bar_content">
                        <label>Address</label>
                        <p><strong>Head Office</strong> : 11C/1, 3rd Floor, Opposite Najafgarh Metro Station Gate No.2, New Delhi 110043</p>
                        <p><strong>INDIA</strong> : <b>Rishikesh</b><br> 59, Mani Ram Marg, Near Jagannath Ashram, Rishikesh, Dehradun, Uttarakhand - 249201</p>
                        <p><strong>Overseas</strong> : <b>CANADA</b><br> 72A avenue, Surrey, British Columbia, Canada.</p>
                    </div>
                </div>
                <div class="dir-blocks">
                    <div class="address_bar_content">
                        ...
                        <a href="mailto:bd@vyaparkrant.com">bd@vyaparkranti.com</a>
                    </div>
                </div>
                <div class="dir-blocks">
                    <div class="address_bar_content">
